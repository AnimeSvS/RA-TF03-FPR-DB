...
using UnityEngine;
//Referenciar el paquete descargado DOTween
using DG.Tweening;
//Agregar el metodo de system
using System;

public class UIManager : MonoBehaviour
{
    //Crear los campos de GameObjet de la interfaz
    ...
    void Start()
    {
        //funciones vinculados a los eventos del GameManager
        GameManager.instance.OnMainMenu += ActivateMainMenu;
        GameManager.instance.OnItemsMenu += ActivateOnItemsMenu;
        GameManager.instance.OnARPosition += ActivateARPosition;
        //-------------------------------------------------------
    }

    //funciones de animacion para el main
    private void ActivateMainMenu()
    {
        //--------------orden de los botones-----------escala del boton -------duracion del la animacion--
    ...
    //funciones de animacion para el item
    private void ActivateOnItemsMenu()
    {
        ...
        itemsMenuCanvas.transform.GetChild(1).transform.DOMoveY(420, 0.3f);
        //-------------------------------------------------------------------------------------------
    }
    //funciones de animacion para activar la posicion
